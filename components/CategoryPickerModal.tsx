...
//   useEffect(() => {
//     if (visible) getCategories().then(setCategories);
//   }, [visible]);
...
//     setCreating(true);
//     try {
//       const cat = await createCategory(categoryName.trim(), color);
...
//     textAlign: "center",
//   },
//   list: { maxHeight: 150, marginBottom: 12 },
...
//     marginBottom: 16,
//   },
//   pickerContainer: { height: 300, marginBottom: 20, alignItems: "center" },
//   button: {
...
const CategoryPickerModal: React.FC<Props> = ({
  ...
  const handleCreate = async () => {
    ...
    setCreating(true);
    try {
      const newCat = await createCategory(categoryName.trim(), color);
